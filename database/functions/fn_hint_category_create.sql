...
-- Creates a hint category.
-- If parent_id=0, creates a root category (self-referencing hint_category_id).
-- If parent_id>0, creates a nested sub-category inheriting hint_category_id from parent.
...
BEGIN
    ...
    ELSE
        -- Nested sub-category: inherit hint_category_id from parent
